...
![workflow](https://github.com/MTDickens/research-code-python-starter-template/actions/workflows/ci.yml/badge.svg)
...
### Set Up the Code
2. **Clone this repository** and give it the name of your repo: `git clone https://github.com/MTDickens/research-code-python-starter-template <NAME>`. You now have a directory called NAME. **Enter** it: `cd <NAME>`.
...
7. **Set up your dev environment (uv)**:
